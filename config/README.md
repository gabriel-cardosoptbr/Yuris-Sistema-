...
| `rotas.php` | a tabela de rotas de `public/`. Só o que a sondagem automática não resolve sozinha: a home, página que more fora de `public/`, e endereço desativado que só redireciona. **Mudar uma chave daqui muda um endereço público** |
