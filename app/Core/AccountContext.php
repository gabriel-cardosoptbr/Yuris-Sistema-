...
class AccountContext
{
    ...
    public function getAccessibleAccountIds(?string $module = null): array
    {
        ...
        if ($this->accountTipo !== 'advogado') {
            try {
                if (!class_exists('App\\Usuarios\\AdvogadoVinculo')) {
                    require_once __DIR__ . '/../Usuarios/AdvogadoVinculo.php';
                }
                ...
                $advogadoIds = \App\Usuarios\AdvogadoVinculo::advogadosAtivosDeHost($this->accountId, $modKey);
