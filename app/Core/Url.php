 ...
 *
 * // PHP redirect:
 * header('Location: ' . \App\Core\Url::to('/login.php'));
 *
 * // HTML href:
 * <a href="<?= \App\Core\Url::to('/dashboard.php') ?>">Dashboard</a>
 *
 * // CSS/JS asset:
 * <link rel="stylesheet" href="<?= \App\Core\Url::asset('/assets/style.css') ?>">
 * <script src="<?= \App\Core\Url::asset('/assets/app.js') ?>"></script>
 *
 * // JS inline via base:
 * <base href="<?= \App\Core\Url::base() ?>/">  ← pro browser resolver relativos
 *
 * ──────────────────────────────────────────────────────────────────────
 * COMPORTAMENTO
 * ──────────────────────────────────────────────────────────────────────
