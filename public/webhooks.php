...
User-Agent: Yuris-Webhook/1.0</pre>
        ...
        $modColors = ['Prospecção — Clientes'=>'#60a5fa','Prospecção — Cards'=>'#a78bfa','Abas do Card'=>'#c4b5fd','Processos / Jurídico'=>'#34d399','Abas do Processo'=>'#22d3ee','Financeiro'=>'#fbbf24','Usuários / Equipe'=>'#f472b6','Sistema'=>'#94a3b8'];
        ?>
...
endforeach; ?>  },
  ...
  document.getElementById('whDelete').addEventListener('click', async ()=>{
    const id = document.getElementById('whId').value;
    if (!id||!confirm('Excluir este webhook?')) return;
